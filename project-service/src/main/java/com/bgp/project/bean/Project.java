...
public class Project implements Serializable {
	...
	/**
	 * @return the iskeyProgram
	 */
	public String isIskeyProgram() {
		return iskeyProgram;
	}
	/**
	 * @param iskeyProgram the iskeyProgram to set
	 */
	public void setIskeyProgram(String iskeyProgram) {
		this.iskeyProgram = iskeyProgram;
	}
	/**
